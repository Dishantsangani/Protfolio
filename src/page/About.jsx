...
import dev from "../assets/Dishant/IMG_3626.png";
        ...
        <div className="max-w-5xl px-4 xl:px-0 py-10 lg:py-20 mx-auto">
          ...
          <div className="md:grid md:grid-cols-2 md:gap-10 lg:gap-16 md:items-center">
            <div>
              {/* Blockquote */}
              <blockquote>
                <p className="font-medium text-xl text-gray-300 md:text-2xl  md:leading-normal xl:text-xl xl:leading-normal">
                  I’m a passionate Full Stack Developer with practical
                  experience in building modern, responsive, and
                  high-performance web applications using the MERN stack
                  (MongoDB, Express.js, React.js, Node.js). I focus on creating
                  clean, scalable codebases, intuitive user interfaces, and
                  secure backend systems. My expertise includes building RESTful
                  APIs, handling authentication with JWT, managing state in
                  React, and deploying full-stack apps on platforms like Vercel
                  and Render.
                </p>
